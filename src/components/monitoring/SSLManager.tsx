...
// Generate mock SSL certificates
const generateMockCertificates = (): SSLCertificate[] => {
...
export function SSLManager() {
  ...
  const [certificates, setCertificates] = useState<SSLCertificate[]>(generateMockCertificates);
  ...
  const handleRenewAll = async () => {
    ...
    for (const cert of certificates.filter(c => c.status === 'expiring_soon' || c.status === 'expired')) {
